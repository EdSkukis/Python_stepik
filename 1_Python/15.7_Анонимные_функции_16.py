...
primary_city = filter(lambda num: num[2] == 'primary' and num[1] > 10000000, data)
only_city = map(lambda num: num[0], primary_city)
alfa_city = sorted(only_city)
cities = reduce(lambda x, y: x + y + ', ', alfa_city, 'Cities: ')
